...
# $Header: /home/mjr/tmp/tlilycvs/lily/tigerlily2/TLily/Attic/User.pm,v 1.27.2.1 2000/01/05 10:26:19 albert Exp $

package TLily::User;

use strict;
use vars qw(@ISA @EXPORT_OK %abbrevs);
...
@ISA = qw(Exporter);
@EXPORT_OK = qw(&help_r &shelp_r &command_r %abbrevs);
